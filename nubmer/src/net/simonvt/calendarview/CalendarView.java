...
public class CalendarView extends FrameLayout {
    ...
    public CalendarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectedDateVerticalBar = attributesArray
                .getDrawable(R.styleable.CalendarView_cv_selectedDateVerticalBar);

        mDateTextAppearanceResId = attributesArray.getResourceId(
                R.styleable.CalendarView_cv_dateTextAppearance,
        ...
        final Drawable horizontalDivider = attributesArray
                .getDrawable(R.styleable.CalendarView_cv_dividerHorizontal);
        ...
        mSelectedDateVerticalBarWidth = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, UNSCALED_SELECTED_DATE_VERTICAL_BAR_WIDTH,
                displayMetrics);
    ...
    /**
     * Gets the minimal date supported by this {@link CalendarView} in
    ...
    /**
     * Sets the minimal date supported by this {@link CalendarView} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link TimeZone#getDefault()} time zone.
     * 
     * @param minDate
    ...
    public void setMinDate(long minDate) {
        ...
        if (date.before(mMinDate)) {
            ...
            // note that calling setDate will not work since the date is the
            // same
    ...
    /**
     * Gets the maximal date supported by this {@link CalendarView} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link TimeZone#getDefault()} time zone.
     * <p>
    ...
    /**
     * Sets the maximal date supported by this {@link CalendarView} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link TimeZone#getDefault()} time zone.
     * 
     * @param maxDate
     ...
     *             of the provided date is before the minimal or after the
     *             maximal date.
     * 
     ...
     * 
     * @throws IllegalArgumentException
     *             of the provided date is before the range start of after the
     *             range end.
     */
    private void goTo(Calendar date, boolean animate, boolean setSelected, boolean forceScroll) {
        if (date.before(mMinDate) || date.after(mMaxDate)) {
            throw new IllegalArgumentException("Time not between " + mMinDate.getTime() + " and "
                    + mMaxDate.getTime());
        }
    ...
    private class WeekView extends View {
        ...
        private void drawSelectedDateVerticalBars(Canvas canvas) {
            ...
            mSelectedDateVerticalBar.setBounds(mSelectedLeft - mSelectedDateVerticalBarWidth / 2,
                    mWeekSeperatorLineWidth, mSelectedLeft + mSelectedDateVerticalBarWidth / 2,
                    mHeight);
            mSelectedDateVerticalBar.draw(canvas);
            mSelectedDateVerticalBar.setBounds(mSelectedRight - mSelectedDateVerticalBarWidth / 2,
                    mWeekSeperatorLineWidth, mSelectedRight + mSelectedDateVerticalBarWidth / 2,
                    mHeight);
            mSelectedDateVerticalBar.draw(canvas);
        }
