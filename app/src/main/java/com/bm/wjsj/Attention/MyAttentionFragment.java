 ...
 * 我的关注
 */
public class MyAttentionFragment extends Fragment implements APICallback.OnResposeListener{
    private View view;
    private RefreshLayout rfl_lv;
    private ListView listview;
    private AttentionAdapter adapter;
    private List<AttentionListBean> list = new ArrayList<>();
    private String attentionType = "1";//0:相互关注（默认） 1：我的关注 2：关注我的
    private int pageNum = 1, pageSize = 10;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fg_my_attention, container, false);
        WebServiceAPI.getInstance().getattentionlist(attentionType, pageNum, pageSize, MyAttentionFragment.this, getActivity());
        initView();
        return view;
    }
