 ...
 * 相互关注
 */
public class MutualAttentionFragment extends Fragment implements APICallback.OnResposeListener {
    private View view;
    private RefreshLayout rfl_lv;
    private ListView listview;
    private AttentionAdapter adapter;
    public static List<AttentionListBean> list = new ArrayList<>();
    private String attentionType = "0";//0:相互关注（默认） 1：我的关注 2：关注我的
    private int pageNum = 1, pageSize = 10;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fg_mutual_attention, container, false);
        WebServiceAPI.getInstance().getattentionlist(attentionType, pageNum, pageSize, MutualAttentionFragment.this, getActivity());
        initView();
        return view;
    }
