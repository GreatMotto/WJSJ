...
public class FocusFragment extends Fragment implements APICallback.OnResposeListener {
    ...
    private String dynamicType = "0";//0：关注（默认） 1：热门 2：附近
    private int pageNum = 1, pageSize = 10;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fg_dynamic_focus, container, false);
        WebServiceAPI.getInstance().dynamicList(dynamicType, pageNum, pageSize, FocusFragment.this, getActivity());
        initView();
        return view;
    }
