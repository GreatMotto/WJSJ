 ...
 */
public class NearFragment extends Fragment implements APICallback.OnResposeListener{
    private View view;
    private RefreshLayout rfl_lv;
    private ListView listview;
    private DynamicAdapter adapter;
    private List<DynamicListBean> list = new ArrayList<>();
    private String dynamicType = "2";//0：关注（默认） 1：热门 2：附近
    private int pageNum = 1, pageSize = 10;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fg_dynamic_near, container, false);
        WebServiceAPI.getInstance().dynamicList(dynamicType, pageNum, pageSize, NearFragment.this, getActivity());
        initView();
        return view;
    }
