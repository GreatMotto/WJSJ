...
public class RatingBarView extends LinearLayout {
    ...
    public RatingBarView(Context context, AttributeSet attrs) {
        ...
        starImageSize = a.getDimension(R.styleable.RatingBarView_starImageSize, 40);
    ...
    private ImageView getStarImageView(Context context, AttributeSet attrs) {
        ...
        imageView.setMaxWidth(DisplayUtil.dip2px(context, 50));
        imageView.setMaxHeight(DisplayUtil.dip2px(context,50));
        return imageView;
