 ...
 * <b>http://blog.csdn.net/bfbx5173/article/details/45191147<b>
 *
 * @author QQ 517309507
 */
public class SwitchView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        rectF.left = sLeft + bStrokeWidth / 10;
        rectF.right = sRight - bStrokeWidth / 10;
        rectF.top = sTop + bStrokeWidth / 10;
        rectF.bottom = sBottom - bStrokeWidth / 10;
        shadowGradient = new RadialGradient(bWidth / 2, bWidth / 2, bWidth / 2, 0xff000000,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //0xff4bd763  选中背景色  0xffe3e3e3 阴影色
        paint.setColor(isOn ? 0xfffe9293 : 0xffe2e1e4);
//        canvas.drawPath(sPath, paint);
        ...
        paint.setColor(0xffe2e1e4);//未选中背景色
        canvas.drawPath(sPath, paint);//打开时的效果
//        canvas.drawRoundRect(rectF, 5, 5, paint);
        canvas.restore();
        // draw center bar
...
//        canvas.drawPath(bPath, paint);
        canvas.drawRoundRect(bRectF, 5, 5, paint);
//        paint.setStyle(Style.STROKE);
//        paint.setStrokeWidth(bStrokeWidth * 0.5f);
//        //按钮边框色
//        paint.setColor(isOn ? 0xfffe9293 : 0xffbfbfbf);
//        canvas.drawPath(bPath, paint);
